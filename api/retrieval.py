...
def generate_feedback(start_date, end_date):
    ...
    # for document, score in filtered_pos_docs:
        # Pdoc +=  "\n -" + document.page_content 
    mainmodel = 'phi3:3.8b-mini-128k-instruct-q4_K_M'
    ...
    response = ollama.generate(model=mainmodel, prompt=modelquery, stream=False)
...
# generate_feedback(20220101, 20220131)